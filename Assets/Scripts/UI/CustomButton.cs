...
public class CustomButton : Selectable, IBeginDragHandler, IDragHandler, IEndDragHandler, ISubmitHandler
{
    ...
    [SerializeField][Tooltip("This Button can only trigger the OnClicked Event once. Use ResetIsClicked() to make it fire the event again.")]
    private bool onlyAllowClickingOnce = false;
    [SerializeField][Tooltip("You can't click the button this many seconds after it has been pressed.")]
    private float clickTimeOut = 0.1f;
    [SerializeField][Tooltip("Which Object to Select after Clicking the button. QOL thing. Defaults to itself when unassigned.")]
